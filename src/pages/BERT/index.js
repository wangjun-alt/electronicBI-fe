...
import { Cascader, InputNumber, Toast, Input, DatePicker, TextArea, Modal } from '@douyinfe/semi-ui'
...
function BERT () {
  ...
  return <div
    ...
    >
      <Link to={{ pathname: "/" }} style={{ color: 'black' }}><ArrowLeftOutlined style={{ fontSize: '26px', margin: 4, color: 'black' }} />OCR文字提取</Link>
    </Typography.Title>
    <Row>
      <Col
        style={{
      ...
      <Col
        ...
        >
          ...
          >
            ...
            >
              <Input placeholder='请输入合同编号' style={{ width: 300, }} />
            </Form.Item>
            <Form.Item
              label="合同名称"
              name="contract_name"
            ...
            >
              <Input placeholder='请输入合同名称' style={{ width: 300, }} />
            </Form.Item>
            <Form.Item
              label="合同甲方"
              name="part_a"
            ...
            >
              <DatePicker type="dateRange" style={{ width: 350 }} />
            </Form.Item>
            <Form.Item
              label="售电方所在地"
              name="sale_loc"
            ...
            <TextArea maxCount={50} showClear style={{ marginBottom: 20, width: 300 }} placeholder="请填写详细地址" value={saleLoc} onChange={(value) => {
              setSaleLoc(value)
            }} />
            <Form.Item
              label="购电方所在地"
            ...
            <TextArea maxCount={50} style={{ width: 300 }} showClear placeholder="请填写详细地址" value={buyLoc} onChange={(value) => {
              setBuyLoc(value)
            }} />
            <Typography.Title
              level={4}
            ...
            <Form.Item>
              <Button type="primary" htmlType="submit" style={{ marginLeft: 120, marginTop: 20 }}>
                提交
              </Button>
            </Form.Item>
          </Form>
